...
import {
  editExpense,
  deleteExpense,
} from "../../../../states/reducers/expense-reducer";
import {
  setAlertMessage,
  setAlertType,
  setAlertVisibility,
} from "../../../../states/reducers/alert-reducer";
...
function ExpenseCard({
  ...
  const deleteExpenseHandler = () => {
    deleteExpenseById(id, idToken)
      .then(() => {
        setAlert("delete successfully" , "warning")
      ...
      <div className={[styles.card, isDarkMode ? styles.dark : ""].join(" ")}>
        ...
        <div className={styles.description}>
          {!editCard ? (
            ...
            <select id="category" ref={editCategory}>
